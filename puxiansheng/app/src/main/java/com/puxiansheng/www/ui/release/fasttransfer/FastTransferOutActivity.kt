...
class FastTransferOutActivity : MyBaseActivity() {
...
//        bg_img.layoutManager = LinearLayoutManager(this)
        lifecycleScope.launch {
            viewModel.requestBannerImage("api_fast_transfer_images")?.let {
//                it -> bg_img.adapter = FastTransferImgAdapter(it)
...
//        super.onResume()
//        MobclickAgent.onPageStart("FastTransferOutActivity") //统计页面，"MainScreen"为页面名称，可自定义
//    }
//
//    override fun onPause() {
//        super.onPause()
//        MobclickAgent.onPageEnd("FastTransferOutActivity")
//    }

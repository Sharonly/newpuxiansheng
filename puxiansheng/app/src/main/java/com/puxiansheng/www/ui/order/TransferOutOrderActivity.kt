...
class TransferOutOrderActivity : MyBaseActivity() {
    ...
    private fun initView() {
        ...
        DividerItemDecoration(this@TransferOutOrderActivity, DividerItemDecoration.VERTICAL).let {
            it.setDrawable(resources.getDrawable(R.drawable.recyclerview_divider_order, null))
            order_list.addItemDecoration(it)
        }

        order_list.layoutManager = LinearLayoutManager(this@TransferOutOrderActivity)
        order_list.adapter = OrdersAdapter(
            ...
            LivePagedListBuilder<Int, Order>(
                ...
                pageBuilder.build().observe(this@TransferOutOrderActivity, Observer {
                    submitList(it)
                    notifyDataSetChanged()
                })
            }

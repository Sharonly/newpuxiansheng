...
import static com.zhiniao.player.utils.StringUtils.generateTime;
...
//                start();
     ...
     * 隐藏除视频外所有视图
     */
    public void _hideAllView(boolean isTouchLock) {
//        mPlayerThumb.setVisibility(View.GONE);
    ...
    public void setlock() {
        _togglePlayerLock();
        // mIvPlayerLock.setVisibility(View.G);
    }

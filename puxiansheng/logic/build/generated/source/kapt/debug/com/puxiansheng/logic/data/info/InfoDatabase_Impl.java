  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `table_info` (`_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `_user_id` INTEGER NOT NULL, `_info_id` INTEGER NOT NULL, `_title` TEXT NOT NULL, `_release_date` TEXT NOT NULL, `_image` TEXT NOT NULL, `_category` INTEGER NOT NULL, `_author` TEXT NOT NULL, `_url` TEXT NOT NULL, `_page_views` INTEGER NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'a380bdb5bd3c1fb6a548ee311005ed94')");
      }
    ...
    }, "a380bdb5bd3c1fb6a548ee311005ed94", "f82c2cc04922360bfe2c613832d9834d");
